...
precos_array = np.genfromtxt("C:\\Users\\dialuan.lima\\Documents\\CursoAnalistaDadosBigData2026\\UC2\\aula05\\vendas_produtos.csv", delimiter=',', skip_header=1, dtype=None, encoding='utf-8', usecols=3)
print(precos_array)
